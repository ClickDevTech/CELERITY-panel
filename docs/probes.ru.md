...
Замер скорости расходует реальный трафик на ваших же нодах, поэтому он ограничен с трёх сторон, а суточный бюджет расходуется по кругу между нодами.
...
Результаты по ресурсам вынесены отдельно: заблокированный ресурс указывает на гео-блок или адрес выхода в чёрном списке. Блокировкой считаются только 403 и 451; 500 или транспортная ошибка записывается как неуспешная проверка.
